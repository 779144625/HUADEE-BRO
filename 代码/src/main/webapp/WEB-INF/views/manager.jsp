  ...
  <!--middle-->
    <div id="content">
    	<div id="paple">
    		<ul>
    			<li>
                    <a href="/staff/findalll"><img src="/image/message.png"/>
                        <h3>组员信息查询</h3>
                    </a>	
                </li>
                <li>
                    <a href="/admin/findhistory"><img src="/image/news.png"/>
                        <h3>维修历史记录</h3>
                    </a>		
                </li>
                <li>
                    <a href="/admin/result"><img src="/image/news.png"/>
                        <h3>维修进度记录</h3>
                    </a>		
                </li>
				<li>
					<a href="/user/add" onclick="distinguish()"><img src="/image/wrong.png"/>
						<h3>添加用户</h3>
					</a>
				</li>
    		</ul>
