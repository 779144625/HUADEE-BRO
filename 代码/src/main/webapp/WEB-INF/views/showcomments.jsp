        ...
        <c:forEach items="${allComments}" var="comment">
            <div class="comment">
                ...
                <div class="comment_content">
                    ...
                    <form action="/comments/dianzan?id=${comment.commentId}" method="post">

                        <button style="margin: 0;padding: 0;outline: none;border: 0;background-color: white;">
                            <img style="width: 27px;height: 25px;" src="/image/zan.png" alt="赞"/>
                            ${comment.ifSatisfied}
                        </button>
                    </form>
                </div>
